...
# =============================================================================
import hermes_cli.worktree as _worktree_mod
...
# ---------------------------------------------------------------------------
from hermes_cli.attachments import (
    _IMAGE_EXTENSIONS,
...
from hermes_cli.terminal_input import (
...
def main(
    ...
    if not list_tools and not list_toolsets:
        ...
        if use_worktree:
            ...
            if wt_info:
                _worktree_mod._active_worktree = wt_info
